...
width: 100px;height:30px;border-radius: 5px;" onclick="window.location.href='en/m_notes/catelogue'">
        Miscellaneous Notes
    </button>
</p>
...
<p>
  ...
  <img src="https://img.shields.io/badge/-php-777BB4?logo=php&logoColor=FFF" alt="Java" style="display: inline-block;" />&nbsp;
